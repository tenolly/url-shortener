...
function swapTextAndIcon() {
    document.getElementById("copy_button").innerHTML = '<span class="copy_button_text">Copied</span>'
    setTimeout(() => {
        document.getElementById("copy_button").innerHTML = `<svg class="svg_icon" viewBox="0 0 20 20">
            <path
